...
namespace Performance
{
    public partial class ProjectListForm : BaseForm
    {
        ...
        private Performance.Infrastructure.Entities.ProjectEntity? _selectedProject;
        ...
        {
            if (sender is Control c && c.Tag is Performance.Infrastructure.Entities.ProjectEntity proj)
            {
        ...
        private void PopulateGallery(System.Collections.Generic.List<Performance.Infrastructure.Entities.ProjectEntity> projects)
        {
