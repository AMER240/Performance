...
namespace Performance
{
    public partial class MainForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private async Task AddProject_Click()
        {
            ...
            var projectSuggestionService = scope.ServiceProvider.GetRequiredService<IProjectSuggestionService>();
            var form = new ProjectEditForm(projectService, projectSuggestionService, _authenticatedUser);
