...
using UserRole = Performance.Domain.Enums.UserRole;
            ...
            try
            {
                if (_task == null)
                {
                    var t = new TaskEntity
                    {
                        ...
                        Status = Enum.Parse<TaskStatus>(cboStatus.SelectedItem?.ToString() ?? "Todo"),
                ...
                else
                {
                    ...
                    _task.Status = Enum.Parse<TaskStatus>(cboStatus.SelectedItem?.ToString() ?? "Todo");
